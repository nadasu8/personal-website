...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (in_array($fileType, ['jpg', 'jpeg', 'png', 'gif'])) {
        ...
        echo "Unsupported file type: $fileType"; // Debug line
        header("Location: teachingAdmin.php");
        exit();
    }
    ...
    // Debug line to check file details
    echo "File details: ";
    print_r($file);
    ...
    if (move_uploaded_file($file['tmp_name'], '../' . $filePath)) {
        echo "File uploaded successfully to " . '../' . $filePath . "<br>"; // Debug line
        // Database connection
        ...
        $sql = "INSERT INTO teaching_media (title, description, media_type, media_path) 
        ...
        $_SESSION['error_message'] = "File upload failed. Error code: " . $_FILES['mediaFile']['error'];
        echo "File upload failed. Error code: " . $_FILES['mediaFile']['error']; // Debug line
    }
...
<head>
    ...
    <!-- Inline CSS for admin teaching page -->
    <!--CSS -->
                ...
                <div class="content-container">
                    <?php if (isset($_SESSION['success_message'])): ?>
                        <script>
                            ...
                            window.location.href = "teachingAdmin.php";
                        </script>
